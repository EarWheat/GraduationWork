export default {
  ...
  'app.analysis.total-sales': '总网络流',
  'app.analysis.day-sales': '日销售额',
  'app.analysis.visits': '异常流量数',
  'app.analysis.visits-trend': '访问量趋势',
  'app.analysis.visits-ranking': '流量种类访问量排名',
  'app.analysis.day-visits': '今日异常流量数',
  'app.analysis.week': '周同比',
  'app.analysis.day': '日同比',
  'app.analysis.payments': '24小时内流量数',
  'app.analysis.conversion-rate': '转化率',
  'app.analysis.operational-effect': '运营活动效果',
  'app.analysis.traffic-trend': '流量趋势',
